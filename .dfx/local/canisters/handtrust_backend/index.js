...
import { idlFactory } from './handtrust_backend.did.js';
export { idlFactory } from './handtrust_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HANDTRUST_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./handtrust_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the handtrust_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./handtrust_backend.did.js")._SERVICE>}
 */
export const handtrust_backend = createActor(canisterId);
