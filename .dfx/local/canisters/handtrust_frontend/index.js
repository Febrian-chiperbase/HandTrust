...
import { idlFactory } from './handtrust_frontend.did.js';
export { idlFactory } from './handtrust_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HANDTRUST_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./handtrust_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the handtrust_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./handtrust_frontend.did.js")._SERVICE>}
 */
export const handtrust_frontend = createActor(canisterId);
